...
<body>
	...
	<div id="main">
	<div class="header">
	<span id="appname">xdi2-mongodb</span>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<% for (int i=0; i<((Integer) request.getAttribute("sampleInputs")).intValue(); i++) { %>
		<a href="XDIMongoDB?sample=<%= i+1 %>">Sample <%= i+1 %></a>&nbsp;&nbsp;
	<% } %>
	</div>
	...
	<form action="XDIMongoDB" method="post" accept-charset="UTF-8">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;<a href="XDIMongoDBHelp.jsp">What can I do here?</a>
	...
	<% if (request.getAttribute("mongoDBApiLog") != null) { %>
		<div class="result"><pre><%= request.getAttribute("mongoDBApiLog") %></pre></div><br>
	<% } %>
